...
class behavpy_plotly(behavpy_core):
    """
    default plotly wrapper around core_behavpy
    """
...
class behavpy(behavpy_plotly):
    """ 
    Just an alias of behavpy_ploty to maintain compatibility for the time being
    """
    pass